...
import numpy as np
import random
from model_snn import Supernet, is_single_path, get_SAR,prune_func_rank_dvs
...
def main():
    ...
    if args.arch_param == None:
      ...
      while not is_single_path(network):
        epoch += 1
        print('epoch:',epoch)
        arch_parameters, op_pruned = prune_func_rank_dvs(args, arch_parameters, trainset,val_loader, search_space,network)
